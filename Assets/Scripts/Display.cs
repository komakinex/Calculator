...
namespace MVRP.Views
{
	...
	public class Display : MonoBehaviour
	{
		// Button
		// Number
		[SerializeField] private Button _btnZero, _btnOne, _btnTwo, _btnThree, _btnFour, _btnFive, _btnSix, _btnSeven, _btnEight, _btnNine;
		// Sign
		[SerializeField] private Button _btnPlus, _btnMulti, _btnDivide, _btnEqual, _btnON;
		...
		private void SubscribeButtons()
		{
			...
			_btnFour.OnClickAsObservable()
				...
				.AddTo(this);
			_btnFive.OnClickAsObservable()
				.Subscribe(_ => {OnButtonClicked.OnNext("5");})
				.AddTo(this);
			_btnSix.OnClickAsObservable()
				.Subscribe(_ => {OnButtonClicked.OnNext("6");})
				.AddTo(this);
			_btnSeven.OnClickAsObservable()
				.Subscribe(_ => {OnButtonClicked.OnNext("7");})
				.AddTo(this);
			_btnEight.OnClickAsObservable()
				.Subscribe(_ => {OnButtonClicked.OnNext("8");})
				.AddTo(this);
			_btnNine.OnClickAsObservable()
				.Subscribe(_ => {OnButtonClicked.OnNext("9");})
				.AddTo(this);;
			// Sign
